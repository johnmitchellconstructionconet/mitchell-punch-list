...
function JobLinkApp({ jobId }) {
  ...
  const byArea = {};
  for (const t of tasks) (byArea[t.area]=byArea[t.area]||[]).push(t);
  const openCount = tasks.filter(t=>t.approval!=="Approved").length;
  const doneCount = tasks.filter(t=>t.approval==="Approved").length;
      ...
      <Shell>
        ...
        <div style={{background:C.mist,borderBottom:`1px solid ${C.line}`,padding:"14px 18px"}}>
          ...
          <div style={{display:"flex",gap:16,marginTop:10,flexWrap:"wrap"}}>
            ...
            <PubStat label="Total"        value={tasks.length} color={C.taupe}/>
          </div>
        ...
        <div style={{maxWidth:900,margin:"0 auto",padding:"16px 14px"}}>
          {tasks.length===0&&<div style={{padding:40,textAlign:"center",color:C.taupe}}>No punch items for this job yet.</div>}
