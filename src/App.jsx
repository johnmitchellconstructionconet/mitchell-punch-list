...
function Modal({children,onClose,wide,xwide}){
  return(
    <div className="no-print" onMouseDown={onClose}
        ...
        <Section title="Progress & Approval">
          ...
          {showRejectForm&&(
            <div onMouseDown={e=>e.stopPropagation()} onClick={e=>e.stopPropagation()}
              style={{marginTop:14,background:"#FDF0EF",border:`1.5px solid ${C.rust}`,borderRadius:10,overflow:"hidden"}}>
              {/* Form header */}
              ...
              <div style={{padding:"12px 14px",borderBottom:`1px solid #F5C6C2`}}>
                ...
                <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
                  {rejectPhotos.map((src,i)=>(
                    <div key={i} style={{position:"relative"}}>
                      ...
                      <button
                        ...
                        onClick={e=>{e.stopPropagation();setRejectPhotos(p=>p.filter((_,j)=>j!==i));}}
                  ...
                  <button
                    onMouseDown={e=>e.stopPropagation()}
                    onClick={e=>{e.stopPropagation();rejectFileRef.current.click();}}
              ...
              <div style={{padding:"10px 14px",display:"flex",gap:8,justifyContent:"flex-end",background:"#F9E5E3"}}>
                <Btn kind="ghost" onMouseDown={e=>e.stopPropagation()} onClick={e=>{e.stopPropagation();setShowRejectForm(false);setRejectReason("");setRejectPhotos([]);}}>Cancel</Btn>
                <Btn kind="red" disabled={!rejectReason.trim()} style={{opacity:rejectReason.trim()?1:0.4}}
                  onMouseDown={e=>e.stopPropagation()}
